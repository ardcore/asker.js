...
var q = [
	...
	{ topic: 'age', question: '... and you are?', def: 'developer' },
	...
	{ topic: 'hobby', question: 'What\'s your hobby?', callback: function(data) { console.log("Your hobby is", data || " gaming", ", how cool!")}},
	{ topic: 'name_correct', question: function(data) { return "is your name really " + data.name + "?" }, options: ['yes', 'no'], mandatory: true }
]


var q2 = [
	{ topic: 'test', question: 'testing?', options: ['yes', 'no'] }
]
asker.ask(q, function(err, data) {
	if (err) throw err;
	console.log(data);
	asker.ask(q2, function(err, data) {
		console.log("fin.")
		console.log(data);
	})
})
